...
import com.hospital.medication.dto.MedicationInventoryAdjustRequest;
import com.hospital.medication.dto.MedicationStatusChangeRequest;
...
public class MedicationController {
    ...
    @PreAuthorize("hasAuthority('medications:inventory')")
    public ApiResponse<Void> adjustInventory(@PathVariable Long id,
        @RequestBody @Valid MedicationInventoryAdjustRequest req, Principal principal) {
